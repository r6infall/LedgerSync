    ...
    <nav style={{
      ...
      <div className={`nav-menu ${menuOpen ? 'open' : ''}`}>
        ...
        <div className="nav-links" style={{ display: 'flex', gap: '24px' }}>
          ...
          <NavLink to="/reconciliation" onClick={() => setMenuOpen(false)} style={({ isActive }) => ({ textDecoration: 'none', fontSize: '11px', cursor: 'pointer', color: isActive ? '#1A1A1A' : '#999', fontWeight: isActive ? 500 : 400 })}>Compliance</NavLink>
