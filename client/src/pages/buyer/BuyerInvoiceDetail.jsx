    ...
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }}>
         <div>
           ...
           {isMismatch && (
             <Card title="AI Analysis" showMockBadge={true} style={{ marginBottom: '24px', background: '#F8F9FA' }}>
                <p style={{ fontSize: '13px', lineHeight: '1.6', color: '#1A1A1A', margin: 0 }}>
                  <strong>🤖 LedgerSync AI:</strong> {aiAnalysis || `There is a discrepancy of ₹${Math.abs(reconciliation?.differenceAmount || 0).toLocaleString()} detected in the Total Amount. We recommend requesting a change to correct the base amount before approval.`}
                </p>
             </Card>
           )}
